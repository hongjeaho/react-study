...
import {Contents, SearchInput, SearchSpinner, SrOnly} from '../components/main/ContactsSearchComponent'
import {Nav, NavLink} from '../components/main/ContactsNavComponent'
import { Outlet, useLoaderData } from 'react-router-dom'
import { getUserList } from '../data/contactData'
  ...
  return (
    <>
      <SearchContent>
          ...
          <Contents>
            <form role="search">
              <SearchInput name="search" type="search" placeholder='search' aria-label='search contacts' />
              <SearchSpinner hidden={true} aria-hidden/>
          ...
          <Nav>
            <ul>
              {userList.map(item => (
                <li key={item.id}>
                  <NavLink to={`/contacts/${item.id}`}>{item.name}</NavLink>
                </li>
              ))}
            </ul>
          </Nav>
